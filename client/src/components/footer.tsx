export function Footer() {
  return (
    <footer className=" border-zinc-950/10 py-4 text-zinc-600 dark:border-white/10 dark:text-zinc-400 md:py-6">
      <div className="mx-auto w-full max-w-6xl px-3 md:px-4">
        <div className="flex flex-col items-center gap-2 rounded-2xl border px-3 py-2 text-center text-xs border-white/10 bg-background/60 backdrop-blur-xl md:flex-row md:items-center md:justify-between md:gap-3 md:px-4 md:py-3 md:text-sm md:text-left">
